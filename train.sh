...
CUDA_VISIBLE_DEVICES="0,1,3,4" accelerate launch \
    ...
    --resume_from_checkpoint "/data/sza/model/Meta-Llama-3.1-8B-ReluSparse-Test/checkpoint-2000"
...
# 恢复训练
# accelerate launch --multi_gpu --num_processes=4 change_to_relu_ddp.py \
#     --batch_size 1 --gradient_accumulation_steps 8 \
#     --resume_from_checkpoint "/data/sza/model/Meta-Llama-3.1-8B-ReluSparse-Test/checkpoint-5000"
# 暂停训练
# pkill -STOP -f change_to_relu_ddp.py
# 恢复训练
# pkill -CONT -f change_to_relu_ddp.py